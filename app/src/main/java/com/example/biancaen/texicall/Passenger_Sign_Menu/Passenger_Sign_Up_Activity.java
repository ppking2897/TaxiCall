package com.example.biancaen.texicall.Passenger_Sign_Menu;
...
public class Passenger_Sign_Up_Activity extends AppCompatActivity {
    ...
    public void sign_up(View view){
        ...
        if (!(nameString.equals("") || passwordString.equals("") || mailString.equals("") || phoneString.equals(""))) {
            ...
            Connect_API.register(nameString, passwordString, mailString, phoneString, new Connect_API.OnRegisterListener() {
                @Override
